...
const NicolasDupuisScreen = () => {
    
    const navigation = useNavigation();
    const [isFavourite,toggleFavourite] = useState(false);
  return (
    <View className = "bg-white flex-1 ">
    <Image source={require("../assets/Nicolas Dupuis.jpg")}
    ...
    <FontAwesome name="heart-o" size={24} color={isFavourite? "red" : "white"} />
     ...
     <View  style={{borderTopLeftRadius:40,borderTopRightRadius: 40}} className="px-5  flex flex-1 justify-between bg-white pt-8 -mt-14 ">
      <ScrollView showsVerticalScrollIndicator={false} className="space-y-5">
        ...
        <Text style={{fontSize:15}} className="font-bold flex-1 "> Nicolas Dupuis </Text>
        <Text style={{fontSize:15}} className="text-[#BA68C8] font-bold"> 1500DA/H</Text>
        </View>
        <Text style={{fontSize:15}} className="tracking-wide mb-2">  Nicolas Dupuis, maître en anglais, offre des leçons d'une beauté exquise et envoûtante. Sa passion pour la langue anglaise et son approche pédagogique raffinée invitent les élèves à explorer les subtilités de la communication, les transportant dans un voyage linguistique aussi enrichissant qu'inspirant.
</Text>
       ...
       <View className="flex space-y-2"> 
       <Text className="font-bold">Anglais </Text>
       ...
       <View className="flex space-y-2"> 
       <Text className="font-bold">1500DA00DA/H </Text>
...
export default NicolasDupuisScreen