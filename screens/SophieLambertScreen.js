...
const SophieLambertScreen = () => {
    
    const navigation = useNavigation();
    const [isFavourite,toggleFavourite] = useState(false);
  return (
    <View className = "bg-white flex-1 ">
    <Image source={require("../assets/Sophie Lambert.jpg")}
    ...
    <FontAwesome name="heart-o" size={24} color={isFavourite? "red" : "white"} />
     ...
     <View  style={{borderTopLeftRadius:40,borderTopRightRadius: 40}} className="px-5  flex flex-1 justify-between bg-white pt-8 -mt-14 ">
      <ScrollView showsVerticalScrollIndicator={false} className="space-y-5">
        ...
        <Text style={{fontSize:15}} className="font-bold flex-1 "> Sophie Lambert </Text>
        <Text style={{fontSize:15}} className="text-[#BA68C8] font-bold"> 1500DA/Mois</Text>
        </View>
        <Text style={{fontSize:15}} className="tracking-wide mb-2"> Sophie Lambert, spécialiste des Sciences de la Vie et de la Terre (SVT), offre des cours stimulants et captivants. Son dévouement à enseigner cette discipline cruciale inspire ses élèves à explorer et à comprendre les merveilles de la nature avec curiosité et engagement.
</Text>
       ...
       <View className="flex space-y-2"> 
       <Text className="font-bold">SVT </Text>
       ...
       <View className="flex space-y-2"> 
       <Text className="font-bold">1500DA/H </Text>
...
export default SophieLambertScreen