...
const ItemScreen = () => {
  ...
  return (
    ...
    <Image source={require("../assets/photo7.png")}
    ...
    <FontAwesome name="heart-o" size={24} color={isFavourite? "red" : "black"} />
     ...
     <View  style={{borderTopLeftRadius:40,borderTopRightRadius: 40}} className="px-5  flex flex-1 justify-between bg-white pt-8 -mt-14 ">
      <ScrollView showsVerticalScrollIndicator={false} className="space-y-5">
        ...
        <Text style={{fontSize:15}} className="font-bold flex-1 "> Lorem ipsum dolor </Text>
        <Text style={{fontSize:15}} className="text-[#BA68C8] font-bold"> 200DA/H</Text>
        </View>
        <Text style={{fontSize:15}} className="tracking-wide mb-2">  Vivamus lacinia odio vitae vestibulum vestibulum.    metus metus, ullamcorper vel, tincidunt sed, euismod in, nibh. Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.
</Text>
       ...
       <View className="flex space-y-2"> 
       <Text className="font-bold">Maths </Text>
