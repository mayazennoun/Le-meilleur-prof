...
const JulesAbidiScreen = () => {
    
    const navigation = useNavigation();
    const [isFavourite,toggleFavourite] = useState(false);
  return (
    <View className = "bg-white flex-1 ">
    <Image source={require("../assets/Jules Abidi.jpg")}
    ...
    <FontAwesome name="heart-o" size={24} color={isFavourite? "red" : "black"} />
     ...
     <View  style={{borderTopLeftRadius:40,borderTopRightRadius: 40}} className="px-5  flex flex-1 justify-between bg-white pt-8 -mt-14 ">
      <ScrollView showsVerticalScrollIndicator={false} className="space-y-5">
        ...
        <Text style={{fontSize:15}} className="font-bold flex-1 "> Jules Abidi </Text>
        <Text style={{fontSize:15}} className="text-[#BA68C8] font-bold"> 2800DA/Mois</Text>
        </View>
        <Text style={{fontSize:15}} className="tracking-wide mb-2">  Jules Abidi, expert en latin, propose des cours empreints de fascination et d'érudition. Sa passion pour la langue et la culture latines et son approche pédagogique immersive captivent les élèves, les transportant dans un voyage à travers l'histoire et la littérature de l'Antiquité, enrichissant ainsi leur compréhension du monde et de ses racines.
</Text>
       ...
       <View className="flex space-y-2"> 
       <Text className="font-bold">Latin </Text>
       ...
       <View className="flex space-y-2"> 
       <Text className="font-bold">2800DA/H </Text>
...
export default JulesAbidiScreen